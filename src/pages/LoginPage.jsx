...
const LoginPage = () => {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-[hsl(var(--bg-primary))]">
            {/* Dynamic Background Blobs - Adjusted for subtlety */}
            ...
            <div className="glass-card w-[90%] max-w-[400px] p-8 animate-fade-in relative z-10 border border-white/10 shadow-2xl rounded-[1.5rem] backdrop-blur-xl">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    <div>
                        ...
                        <input
                            type="email"
                            required
                            className="input-field w-full py-3 px-4 rounded-lg border-white/10 focus:border-primary/50 text-base transition-all bg-white/5"
                    ...
                    <div className="pt-4">
                        <button
                            type="submit"
                            disabled={loading}
                            className="btn btn-primary w-full justify-center py-3.5 rounded-xl text-base font-bold tracking-wide shadow-lg shadow-primary/20 hover:shadow-primary/30 transition-all transform hover:-translate-y-0.5 active:scale-95"
                        >
