    ...
    return (
        <div
            ...
            style={{
                ...
                marginBottom: '1.5rem',
                // Compensate for parent container padding (1.5rem horizontal, 2rem top)
                marginLeft: '-1.5rem',
                marginRight: '-1.5rem',
                marginTop: '-2rem',
                padding: '10px 1.5rem', // Restore internal padding
                width: 'calc(100% + 3rem)' // Full width relative to parent
            }}
        >
